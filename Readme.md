...
This is a complete stack for running Symfony 5 into Docker containers using docker-compose tool. Contains test application. Don't forget to run database migrations after the installation.
